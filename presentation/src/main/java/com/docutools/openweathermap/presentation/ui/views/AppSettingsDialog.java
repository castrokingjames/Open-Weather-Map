package com.docutools.openweathermap.presentation.ui.views;
...
public class AppSettingsDialog implements Parcelable {
     ...
     */
    public AlertDialog showDialog(DialogInterface.OnClickListener positiveListener,
    ...
    public static class Builder {
         ...
         * Permissions#hasPermissions(Context, String...)} in {@link
